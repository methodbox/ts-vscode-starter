...
class MapViewDirections extends Component {
   ...
   * @decodePolyline
   * @TODO
   * Decoding algorithm for polyline points
   * {TODO} - Make this shit less cryptic; it looks like malware.
   * Shouldn't look like it's been minified when it hasn't - was this copied from somewhere??
   * */
   ...
   * - This probably shouldn't have 15 if statements.
   * - 'mode' takes alternatives like "WALKING" - this probably shouldn't be hard-coded
   */
